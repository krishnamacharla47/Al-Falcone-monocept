...
var AppComponent = /** @class */ (function () {
    function AppComponent(falconeServie) {
    ...
    AppComponent.prototype.getPlanets = function () {
        ...
        this.falconeServie.getPlanets().subscribe(function (data) {
            var _a;
            return (_a = _this.planetList).push.apply(_a, data);
        });
    ...
    AppComponent.prototype.getVehicles = function () {
        ...
        this.falconeServie.getVehicles().subscribe(function (data) {
            var _a;
            return (_a = _this.vehicleList).push.apply(_a, data);
        });
        console.log(this.vehicleList);
    };
    AppComponent.prototype.changePlanets = function (filterVal) {
    ...
    AppComponent.prototype.setradio = function (e) {
        console.log(e);
